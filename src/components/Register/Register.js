...
function Register({isSignUpPopupOpen, onClose, handleRegisterSubmit, onReset, handleChange, errors, submitError, isValid, openSignInPopup, isLoading}) {
  return (
        ...
        <form className="popup__form" onSubmit={handleRegisterSubmit} onReset={onReset} noValidate>
         ...
         <label className="popup__label" htmlFor="password">
          ...
          <label className="popup__label" htmlFor="username">
                Username
                <input className="popup__input" id="username-input" name="username" type="text" placeholder="Enter your username" required onChange={handleChange} disabled={isLoading === 'auth'}/>
